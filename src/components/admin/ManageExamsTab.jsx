...
// ==========================================
// קומפוננטת שורת הניהול להסברי AI (מתוקן לארכיטקטורה החדשה)
// ==========================================
const AiExplanationManager = ({ questionIndex, explanationData, onDelete }) => {
    // התיקון: אנחנו לא מחפשים יותר את הטקסט, כי הוא בנתיב המבודד.
    // אנחנו בודקים רק אם אובייקט explanationData קיים במערכת עבור השאלה הזו
